...
# python disjunctive_dual/train.py --dataset set_cover --cfg_idx 0 --resume
# python disjunctive_dual/eval.py --dataset set_cover --cfg_idx 0 --model_suffix "resume_from_set_cover_cfg0" --eval_split test
...
# python disjunctive_dual/train.py --dataset set_cover --cfg_idx 5
# python disjunctive_dual/eval.py --dataset set_cover --cfg_idx 5 --eval_split test

python disjunctive_dual/train.py --dataset set_cover --cfg_idx 5 --resume
python disjunctive_dual/eval.py --dataset set_cover --cfg_idx 5 --model_suffix "resume_from_set_cover_cfg5" --eval_split test
